...
export function InvestReasonsSection() {
  ...
  return (
    <section ref={sectionRef} className="py-12 sm:py-14 md:py-16 relative w-full">
      ...
      <div className="absolute top-[20%] -right-[10%] w-[500px] h-[500px] bg-[#ff8a00]/5 blur-[150px] rounded-full pointer-events-none z-0" />
          ...
          {reasons.map((item, index) => (
            ...
            >
              ...
              <div className="relative mb-4 md:mb-8">
                ...
                <div className="w-16 h-16 md:w-24 md:h-24 rounded-full border border-[#ffffff15] flex items-center justify-center bg-black/40 backdrop-blur-md relative z-10 transition-all duration-500 group-hover:border-primary/50 group-hover:bg-black/60 group-hover:scale-105 shadow-[inset_0_2px_10px_rgba(0,0,0,0.5)]">
